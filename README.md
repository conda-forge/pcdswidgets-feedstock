...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pcdswidgets-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9345&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pcdswidgets-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pcdswidgets` can be installed with:

```
conda install pcdswidgets
```

It is possible to list all of the versions of `pcdswidgets` available on your platform with:
